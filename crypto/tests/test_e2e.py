...
class CryptoBotTestCases(LiveServerTestCase):
    ...
    def test_add_ruleset(self):
        self.selenium.get(self.live_server_url + reverse('crypto:add_edit_ruleset', args=['Ethereum', 0]))
    ...
    def test_add_rule(self):
        ...
        self.selenium.get(self.live_server_url + reverse('crypto:rules', args=['Ethereum', rs.id]))
